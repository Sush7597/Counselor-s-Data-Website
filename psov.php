...
<div>
<h2 style ="float: left">Program Sourse Outcome Values</h2> <a href = "new_psov.php"> <button type = "button" class = "btn btn-default btn-md" style ="float: right; margin-top: 2.5%; margin-right : 4%;">New Program Source Outcome Value </button></a> 
</div>
<?php 
require 'config.php';
$db = db_open();
$result = mysqli_query($db,"Select * from psov");
include "session.php";

$row= mysqli_fetch_assoc($result);
echo "<div class = 'container' style = 'margin-top : 10%'>";
		$arr = array("ID" , "Program Source Outcome" , "Value" , "Course" , "Academic Year" );
