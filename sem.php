...
<div>
<h2 style ="float: left">Semesters</h2> <a href = "new_sem.php"> <button type = "button" class = "btn btn-default btn-md" style ="float: right; margin-top: 2.5%; margin-right : 4%;">New Semester </button></a> 
</div>
<?php 
require 'config.php';
include "session.php";
...
$db = db_open();
$result = mysqli_query($db,"Select * from semesters");
$row= mysqli_fetch_assoc($result);
echo "<div class = 'container' style = 'margin-top : 10%'>";
		$arr = array("ID" , "Academic Year", "Semester");
