...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
	...
	$value = $_POST['value'];
	$ayear = $_POST['ayear'];
	mysqli_query($db,"Insert into cov(`course`, `course_outcome`, `value`, `ayear`) values ('$course','$co','$value','$ayear')");
...
<div>
<h2 style ="float: left">Course Outcome Values / New Course Outcome Value</h2>
</div>
<center>
				<div class="container">
						...
						<div class="col-xs-8 col-xs-offset-1" style = "margin-top : 7%;">
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4>Create a new Course Outcome Value</h4>
								</div>
								<div class="panel-body">
									<form class = "inline-form" action = "#" method = "POST">
											...
											<div class = "form-group">
												<input type = "text" class = "form-control" name = "co" placeholder = "Course Outcome*"  required />
											</div>
											<div class = "form-group">
