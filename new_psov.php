...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
	...
	$value = $_POST['value'];
	$ayear = $_POST['ayear'];
	mysqli_query($db,"Insert into psov(`course`, `program_source_outcome`, `value`, `ayear`) values ('$course','$pso','$value','$ayear')");
	header("location: psov.php");
...
<div>
<h2 style ="float: left">Program Source Outcome Values / New Program Source Outcome Value</h2>
</div>
<center>
				<div class="container">
						...
						<div class="col-xs-8 col-xs-offset-1" style = "margin-top : 7%;">
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4>Create a new Program Source Outcome Value</h4>
								</div>
								<div class="panel-body">
									<form class = "inline-form" action = "#" method = "POST">
									
											<div class = "form-group">
												<input type = "text" class = "form-control" name = "pso" placeholder = "Program Source Outcome*" required />
											</div>
											<div class = "form-group">
