...
<div>
<h2 style ="float: left">Academic Years</h2> <a href = "new_ayear.php"> <button type = "button" class = "btn btn-default btn-md" style ="float: right; margin-top: 2.5%; margin-right : 4%;">New Academic Year </button></a> 
</div>
<?php 
require 'config.php';
include "session.php";
$db = db_open();
$result = mysqli_query($db,"Select * from ayears");
$row= mysqli_fetch_assoc($result);
echo "<div class = 'container' style = 'margin-top : 10%'>";
		$arr = array("ID" , "Start Year" , "End Year" , "Created At" );
