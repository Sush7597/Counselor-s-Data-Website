...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
	...
	$eyr = $_POST['eyr'];
	$date = date('Y-m-d');
	mysqli_query($db,"Insert into Ayears(`start_year`,`end_year`,`created_at`) values ('$syr','$eyr','$date')");
	header("location: ayears.php");
}
?>
<body>
...
<div>
<h2 style ="float: left">Academic Years / New Academic Year</h2>
</div>
<center>
				<div class="container">
								...
								<div class="panel-body">
									<form class = "inline-form" action = "#" method = "POST">
											...
											<div class = "form-group">
												<input type = "number" class = "form-control" name = "syr" placeholder = "Start Year" required />
											</div>
											<div class = "form-group">
												<input type = "number" class = "form-control" name = "eyr" placeholder = "End Year" required />
											</div>
